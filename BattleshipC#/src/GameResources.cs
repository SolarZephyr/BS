...
public static class GameResources
{
	...
	private static void FreeFonts()
	{
		...
		foreach ( obj o in _Fonts.Values) { //added "o" after obj
	...
	private static void FreeImages()
	{
		...
		foreach ( obj o in _Images.Values) { //added "o" after obj
	...
	private static void FreeSounds()
	{
		...
		foreach ( obj o in _Sounds.Values) { //added "o" after obj
	...
	private static void FreeMusic()
	{
		...
		foreach ( obj o in _Music.Values) { //added "o" after obj
			Audio.FreeMusic(obj);
		}
	}
